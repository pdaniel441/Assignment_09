...
class Track():
    ...
    def title(self,value):
        if type(value) == str:
            ...
            raise Exception('Track title must be string')
    ...
    def length(self,value):
        if type(value) == str:
            ...
            raise Exception('Track length must be string')
    ...
    def get_record(self) -> str:
        """Returns: Track record formatted for saving to file (ie. Comma separated)"""
...
class CD:
    ...
    def __init__(self, cd_id: int, cd_title: str, cd_artist: str) -> None:
        ...
        try:
            ...
            self.__cd_tracks = []  # initialize CD Object with empty list of tracks
    ...
    def cd_id(self, value):
        try:
            ...
            raise Exception('ERROR: CD ID must be an Integer!!')
    ...
    def cd_title(self, value):
        try:
            ...
            raise Exception('ERROR: Title needs to be String!')
    ...
    def cd_artist(self, value):
        try:
            ...
            raise Exception('ERROR: Artist needs to be String!')
    ...
    def rmv_track(self, track_id: int) -> None:
        ...
        try:
            ...
            print('VALUE ERROR: Track ID must be an integer!!')
        
        for track in self.__cd_tracks:
            if track is not None:
                if track_id == track.position:
    ...
    def get_tracks(self) -> str:
        ...
        try:
            if len(self.__cd_tracks) < 1:
                raise Exception('ALBUM IS EMPTY OF TRACKS.')
            else:
                result = ''
                for track in self.__cd_tracks:
                    if track is None:
